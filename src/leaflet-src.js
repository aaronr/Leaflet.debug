...
L.Class.extend = function (props) {
    ...
    var NewClass = eval("1&&function "+props.cStructName+"(){  if(this.initialize){ this.initialize.apply(this,arguments); } if(this._initHooks){this.callInitHooks();} }");
    /*
